...
<body>
    ...
    <div class="outer">
        ...
        <br>
        <!-- 서브메뉴 우측 인덱스 -->
        <div id="index-area"><a href="">홈</a> &gt; <a href="">나의 정보</a> &gt; 1:1문의</div>
        ...
        <div class="inner">
            ...
            <div class="inner">
                ...
                <table id="middleTable" width="900px" height="500px" align="center">
                    ...
                    <tr>
                        <td width="300px" height="30px" align="center" style="font-size: 1.2em; color:gray;">연락처</td>
                        <td style="padding-left: 1%; font-size: 1.3em;">010-7777-7777</td>
                    </tr>
                    <tr>
                        <td width="300px" height="30px" align="center" style="font-size: 1.2em; color:gray;">이메일</td>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 1%; font-size: 1.3em; padding-top: 1%;" valign="top">
                            <textarea id="contentArea" style="font-size: 1.1em;" disabled>너무 맛있는데요 비결이 뭐에요??</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td width="300px" height="200px" align="center" valign="top" style="font-size: 1.2em; color:gray; padding-top: 2%;">답변</td>
                        <td style="padding-left: 1%; font-size: 1.3em; padding-top: 1%;" valign="top">
                            <textarea id="contentArea" style="font-size: 1.0em; color:cornflowerblue" disabled>처리중...</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2" align="left" style="padding-left: 20%;">
                            <br><br>
                            <b style="font-size: 0.8em; color:gray;">등록하신 내용 및 답변은 회원정보상의 이메일로도 발송이 됩니다. 상담원과 통화를 원하시면</b><br>
                            <b style="color:darkslategrey;">고객만족 센터</b> <b style="font-size: 1.0em; color:skyblue;">080-888-8888</b>
                        </th>
                    </tr>
                ...
                <div id="btns"> 
                    ...
                    <button style="background:white; color:black; border:1px solid darkgray" class="middle_btn" id="mbtn">수정</button>
