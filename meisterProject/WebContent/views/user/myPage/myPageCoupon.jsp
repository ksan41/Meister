...
<body>
    ...
    <div class="outer">
        ...
        <br>
        <!-- 서브메뉴 우측 인덱스 -->
        <div id="index-area"><a href="">홈</a> &gt; <a href="">나의 정보</a> &gt; 쿠폰함</div>
        <div class="sub-menu-area">
            <!-- 현재 페이지는 orange 로 표시 -->
            <a href="">주문내역</a>
            <span style="color:lightgray; font-size: 17px;">|</span>
            <a href="" style="color:orange">쿠폰함</a>
            <span style="color:lightgray; font-size: 17px;">|</span>
            <a href="" >1:1문의</a>
            <span style="color:lightgray; font-size: 17px;">|</span>
            <a href="" >정보수정</a>
                ...
                <table style="font-size:16px;" width="1000px" height="200px">
                    <tr>
                        <th width="495px" style="padding-left: 2px; text-align:center;">
	                        <b style="font-weight:bold; font-size: 1.5em;">절대미각</b>님께서 보유하고 있는 할인쿠폰 내역입니다.
	                        <hr class="bline">
	                        <p style="font-size: 0.7em; color:white;">쿠폰을 사용하여 피자를 주문해 보세요!</p>
                        </th>
                        <th width="10px"><hr class="xo"></th>
                        <th style="padding-right: 5%; text-align:center;">
                                보유하고 있는 쿠폰은 <b style="font-weight:bold; font-size: 1.5em;">총 2장</b>입니다.
                        </th>
                    </tr>
