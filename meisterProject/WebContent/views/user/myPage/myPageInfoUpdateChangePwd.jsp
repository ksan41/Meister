...
<body>
	...
	<div class="outer">
        ...
        <div class="inner">
                    ...
                    <tr>
                        <th width="495px" style="padding-left:30px;">
                            <p>
                                ...
                                <hr class="bline">
                                <b style="font-size: 0.7em; color:gray; float: left; margin-left: 48px; margin-bottom: 45px;">회원님의 정보를 정확히 가입하셔야 주문이나 이벤트에 대한 불이익이 없습니다. </b>
                            </p>
                        </th>
            ...
            <div id="btns">
                <button style= color:white; border:1px solid darkgray" class="middle_btn" id="cbtn">초기화</button>
                
                <button class="middle_btn" id="mbtn" style="background-color: red;"data-toggle="modal" data-target="#myModal">수정하기</button>
            </div>
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title" style="margin:auto;padding:0;">내용 : </h4>
        ...
        <button type="button" class="btn btn-danger" data-dismiss="modal"
          style="width:200px; height:50px;">확인</button>

        <button type="button" class="btn btn-danger" data-dismiss="modal"
          style="width:200px; height:50px;">취소</button>
