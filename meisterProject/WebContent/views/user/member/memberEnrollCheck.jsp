...
<title>Insert title here</title>
	...
	<%@ include file="../../common_user/menubarMenuIMG.jsp" %>
        ...
        <!-- 모달 부트스트랩-->
        <link rel="stylesheet" type="text/css" href="<%=contextPath %>/resources/css/bootstrap.css">        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
