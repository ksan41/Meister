...
<head>
    ...
    <style>
	    ...
	    .cntBtn-small button{
	        ...
	        font-size: 16px;
	        border: 0px;
	        background-color: rgb(76, 60, 60); /* 용도에따라 적절하게 orange 나 rgb(76, 60, 60) 골라쓰세요 */
	        font-weight: bolder;
	        color: white;
	    }
	    .cntBtn-small button:hover{cursor: pointer;}
...
<body>
    ...
    <div class="outer">
        ...
        <div class="sub-menu-area">
            ...
            <a href="" >사이드디시</a>
            <span style="color:lightgray; font-size: 17px;">|</span>
            <a href="" style="color:orange" >음료&기타</a>
        </div>
        <hr>
        <!-- inner영역에 콘텐츠 작성 -->
        <div class="inner">
                ...
                <div id="menu-thumb">
                    ...
                    <div id="menu-info">
                        ...
                        <div class="cntBtn-small">
                            <button class="cnt_down">-</button><input class="menu-cnt" type="text" name="count" value="1" readonly><button class="cnt_up">+</button>
                        </div>
                        <br>
