...
<body class="sb-nav-fixed">
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<a class="navbar-brand" href="#" style="font-style: italic;">Meister
			Pizza</a>
		...
		<ul class="navbar-nav ml-auto ml-md-0">
			<li class="nav-item dropdown"><a class="dropdown-item"
				href="<%=contextPath%>/logoutM.me" style="background: orange">Logout</a>
			</li>
		</ul>
	</nav>
	<div id="layoutSidenav">
			...
			<nav class="sb-sidenav accordion sb-sidenav-dark"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						</a> <a class="nav-link" href="<%=contextPath%>/memberList.memg">
							<div class="sb-nav-link-icon">
								<i class="fas fa-user-alt"></i>
							</div>회원관리
						</a> <a class="nav-link" href="<%=contextPath%>/menuMgPizzaList.meng"><div
								class="sb-nav-link-icon">
								<i class="fas fa-book-open"></i>
							</div>메뉴관리</a> <a class="nav-link" href="<%=contextPath%>/couponList.cm"><div
								class="sb-nav-link-icon">
						...
						<a class="nav-link" href="<%=contextPath%>/evMgList.evm"><div
								class="sb-nav-link-icon">
						...
						</a> <a class="nav-link" href="<%=contextPath%>/ceMgOneList.cem">
							<div class="sb-nav-link-icon">
		...
		<script
			...
			crossorigin="anonymous"></script>
		<script
			src="<%=contextPath%>/views/common_manager/resources/admin/dist/js/scripts.js"></script>
		<script
