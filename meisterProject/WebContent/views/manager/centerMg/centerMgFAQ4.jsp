...
<head>
	...
	<title>meister_통합 - FAQ_홈페이지관련</title>
			...
			<div class="card mb-4">
				...
				<div class="card-body">
					<div class="faqBtns">
						...
						<button>주문확인</button>
						<button>포장 주문</button>
						<button class="active">홈페이지 관련</button>
					</div>
					<div align="right">
						...
						<table>
							<tr>
								...
								<td style="width: 800px;">배달사원부족, 주문폭주 등으로 부득이 하게 예약주문만 가능한
									경우가 있습니다. 이 경우 매장이나 콜센터(1577-3082)로 전화하셔도 예약주문만 가능하기 때문에 고객님의
									많은 양해 부탁 드립니다. 또한, 매장 오픈시간 전이나, 영업 종료 후엔느 예약 주문만 가능합니다.</td>
							</tr>
						</table>
						<div align="right">
							<button class="button" onclick="" data-toggle="modal"
