        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-book-open"></i> 피자 리스트</div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <div align="right">
                                    <button class="button" onclick="" data-toggle="modal" data-target="#couponEnrollModal" 
                                ...
                                <div class="inner">
                                    ...
                                    <div class="menu-area premium">
                                        ...
                                        <div id="menu-thumb">
                                            ...
                                            <div id="menu-info">
                                                <h4>치즈케이크 피자<img id="menu-detail" src="img/icons/baseline_search_black_18dp.png" alt="" data-toggle="modal" data-target="#menu-detail-modal"></h4>
                                                <p><b>L</b> 30000원 &nbsp;&nbsp;<b>M</b> 18000원</p>
                                                <button class="button" data-toggle="modal" data-target="#menu-update-Modal">수정</button>
              ...
              <!-- 메뉴상세 모달 시작 -->
  <div class="modal fade" id="menu-detail-modal"> <!-- modal별 id 변경해주세요-->
    <div class="modal-dialog" style="max-width: 100%; width: auto; display: table;">
      <div class="modal-content">
      
        <!-- Modal Header -->
        <div class="modal-header">
          <h2 class="modal-title" style="margin:auto;padding:0;">치즈케이크 피자</h2>
        ...
        <div class="modal-body">
            <div id="menu-detail1-modal">
                <div id="menu-detail1-modal-img">
                    <img id="menu-detail-img" src="pizzas/pizza-2802332_1280.jpg" alt="">
                </div>
                <div id="menu-detail1-modal-info">
                    <h2>메인토핑</h2>
                    <hr>
                    <span id="modal-topping-info">모차렐라, 프로볼로네, 체더, 크리미 고르곤졸라, 갈릭 크림 소스, 토마토 콩피(confit), 뉴욕 스트립 스테이크, 15가지 믹스 슈레드 치즈(화이트 체더, 몬터레이 잭, 에그몬트, 크림치즈, 에멘탈, 카망베르, 블루 치즈, 스모크 치즈, 숙성 체더, 유기농 체더, 고다, 리코타, 파르메산, 그뤼에르, 로마노), 11가지 믹스 옐로우 치즈(부라타, 콜비잭, 만체고, 탈레지오, 보코치니, 페터, 브리, 에담, 마스카포네, 그라나파다노, 미몰레트), 파슬리 드라이</span>
                    <h2>원산지</h2>
                    <hr>
                    <span id="modal-origin-info">오리지널, 나폴리 도우(밀) : 미국산+캐나다산 / 씬 도우(밀) : 미국산 / 슈퍼시드 함유 도우(밀) : 미국산+캐나다산, (흑미) : 국내산 / 뉴욕 스트립 스테이크(쇠고기) : 호주산 / 체더치즈 : 미국, 뉴질랜드, 호주</span>
                </div>
            </div>    
            <div id="menu-detail1-moda2">
                ...
                <h2>메뉴소개</h2>
                <hr>
                <span id="modal-menu-info">
                    청춘 않는 행복스럽고 아니다. 인생의 부패를 천하를 그들에게 청춘 싹이 피다. 장식하는 미묘한 않는 할지라도 위하여, 있는가? 얼마나 우는 자신과 만물은 가치를 실로 넣는 인간의 가진 운다. 고동을 품에 가치를 있다. 꾸며 피는 천지는 위하여서. 굳세게 심장은 속에 대한 있다. 따뜻한 유소년에게서 일월과 봄날의 않는 하는 꽃이 커다란 끓는다. 그들의 크고 방황하였으며, 간에 뿐이다. 평화스러운 영락과 찾아다녀도, 힘차게 밝은 풀밭에 같이, 소리다.이것은 때문이다. 실현에 이 날카로우나 청춘이 타오르고 끓는 있을 것이다.보라, 것이다.
                </span>
            </div>    
        </div>
   ...
   <!-- 메뉴상세 모달 끝 -->
             ...
             <!-- 메뉴수정 모달 시작 -->
             <div class="modal fade" id="menu-update-Modal"> <!-- modal별 id 변경해주세요-->
                <div class="modal-dialog"  style="max-width: 100%; width: auto; display: table;">
                  <div class="modal-content">
                    ...
                    <div class="modal-body" style="width:1100px;height:600px">
                            ...
                            <form id="menuUpdateForm" action="">
                                ...
                                <tr> 
                                    ...
                                    <th rowspan="2">이미지첨부
                                        <input name="menuImg" type="file" style="display: none;">
                                    </th>
                                    <td rowspan="2">
                                ...
                                <tr>
                                    <th>토핑</th>
                                    <td><textarea name="toppings" class="inputs" cols="50" rows="8" style="resize: none;"></textarea></td>
                                                               
                                </tr>
                                <tr>
                                    <th rowspan="2">원산지</th>
                                    <td rowspan="2"><textarea name="origins" class="inputs" cols="50" rows="8"  style="resize: none;"></textarea></td>
                                    <th>M 사이즈 가격</th>
                                    <td><input name="priceM" type="number" class="inputs"> 원<br>
                                    </td>
                                </tr>
                                <tr>
                                    <th>L 사이즈 가격</th>
                                    <td><input name="priceL" type="text" class="inputs"> 원</td>
                                </tr>
                                </table>
                    ...
                    <div class="modal-footer" style="margin:auto;">
                        <!-- 하단버튼 영역-->
                        <button class="big_btn" id="menuUpdateBtn" data-dismiss="modal" style="background: orange;">수정하기</button>
                    </div>
