		...
		<div class="container-fluid">
			...
			<div class="card mb-4">
				<div class="card-header">
					<i class="fas fa-table mr-1"></i> 지점 공지사항 수정
				</div>
				<div class="card-body">
					<div class="table-responsive">
						<form id="updateForm" action="<%= contextPath %>/imNoticeBupdate.nom" method="post">
							...
							<div align="center">
								...
								<button class="button" onclick="location.href='<%= contextPath %>/imNoticeBdetail.nom';">취소</button>
							</div>
						</form>
					</div>
				</div>
