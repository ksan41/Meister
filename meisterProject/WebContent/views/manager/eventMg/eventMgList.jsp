...
<body class="sb-nav-fixed">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i> 이벤트 관리</div>
                            <div class="card-body">

                                <div align="right">
                                    <button class="button" onclick="" data-toggle="modal" data-target="#eventEnrollModal">이벤트 등록</button>
                                </div>

                                <table id="eventListTable" align="center">
                                    <tr>
                                        <td>
                                            <img src="../../resources/admin/img_meister/eventThumbnail/20200331_wCMr6nqu.jpg">
                                            <div align="center">
                                                신학기 기념 3월 신메뉴 행사<br>
                                        ...
                                        <td>
                                            <img src="../../resources/admin/img_meister/eventThumbnail/20200331_lYlQ96T4.jpg">
                                            <div align="center">
                                                신학기 기념 3월 신메뉴 행사<br>
                                                2020-02-10 ~ 2020-03-10
                                    ...
                                    <tr>
                                        <td>
                                            <img src="../../resources/admin/img_meister/eventThumbnail/20200311_K62y1s4N.jpg">
                                            <div align="center">
                                                신학기 기념 3월 신메뉴 행사<br>
                                                2020-02-10 ~ 2020-03-10
                                                <p class="bannerStatus" style="color:red">배너 등록중</p>
                                        ...
                                        <td>
                                            <img src="../../resources/admin/img_meister/eventThumbnail/20200327_4X39ZmU4.jpg">
                                            <div align="center">
                                                신학기 기념 3월 신메뉴 행사<br>
                                                2020-02-10 ~ 2020-03-10
                                                <p class="bannerStatus" style="color:red"></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../../resources/admin/img_meister/eventThumbnail/20200120_ZdUq5370.jpg">
                                            <div align="center">
                                                신학기 기념 3월 신메뉴 행사<br>
                                                2020-02-10 ~ 2020-03-10
                                                <p class="bannerStatus" style="color:red"></p>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="../../resources/admin/img_meister/eventThumbnail/20200131_Npy27D5Z.jpg">
                                            <div align="center">
                                                신학기 기념 3월 신메뉴 행사<br>
                                                2020-02-10 ~ 2020-03-10
                                                <p class="bannerStatus" style="color:red"></p>
                                        ...
                                        <td>
                                            <img src="../../resources/admin/img_meister/eventThumbnail/20200120_h72eVUM8.jpg">
                                            <div align="center">
                                                신학기 기념 3월 신메뉴 행사<br>
                                                2020-02-10 ~ 2020-03-10
                                                <p class="bannerStatus" style="color:red"></p>
        ...
        <!-- 등록 버튼 모달 시작 -->
        <div class="modal fade" id="eventEnrollModal"> <!-- modal별 id 변경해주세요-->
            <div class="modal-dialog">
            <div class="modal-content">
            
                <!-- Modal Header -->
                <div class="modal-header">
                <h4 class="modal-title" style="margin:auto;padding:0;">이벤트 등록</h4>
                ...
                <form action="" name="eventEnrollForm">
                    <table id="eventEnrollTable">
                        <tr>
                            <th>제목</th>
                            <td>
                                <input type="text" placeholder="내용을 입력해주세요" size="40px">
                            </td>
                        </tr>
                        <tr>
                            <th>이벤트 기간</th>
        ...
        <!-- 수정 버튼 모달 시작 -->
        <div class="modal fade" id="eventUpdateModal"> <!-- modal별 id 변경해주세요-->
            <div class="modal-dialog">
            <div class="modal-content">
            
                <!-- Modal Header -->
                <div class="modal-header">
                <h4 class="modal-title" style="margin:auto;padding:0;">이벤트 수정</h4>
                <button type="button" class="close" data-dismiss="modal" style="margin:0;padding:0;">&times;</button>
                </div>
                ...
                <form action="" name="eventUpdateForm">
                    <table id="eventUpdateTable">
                        <tr>
                            <th>제목</th>
                            <td>
                                <input type="text" size="40px" value="기존 이벤트 제목">
                            </td>
                        </tr>
                        <tr>
                            <th>이벤트 기간</th>
